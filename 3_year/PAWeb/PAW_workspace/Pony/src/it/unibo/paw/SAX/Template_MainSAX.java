...
public class Template_MainSAX {
	...
	public static void main(String args[]) {
		...
		try
		{
			...
			// 2.2) ContentHandler
			Template_ErrorHandler errorHandler = new Template_ErrorHandler();		// da sostituire
			...
			xmlReader.parse("src/it/unibo/paw/sources/pony.xml");
			
			// 4) Visualizzare risultato
			Set<String> result = contentHandler.getGiocoTradizionale_Fascia6_8_GI();
			FileWriter fw = new FileWriter("src/it/unibo/paw/sources/Pony.txt");
