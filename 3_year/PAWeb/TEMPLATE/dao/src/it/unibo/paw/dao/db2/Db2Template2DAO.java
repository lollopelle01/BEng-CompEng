...
public class Db2Template2DAO implements Template2DAO {

	// === Costanti letterali per non sbagliarsi a scrivere !!! ============================

	static final String TABLE = "nome_tabella";
	...
	@Override
	public void create(TemplateDTO course) {
	...
	@Override
	public TemplateDTO read(int id) {
		...
		try {
			...
			if (rs.next()) {
				// Creo risultato
				TemplateDTO entry = new TemplateDTO();
	...
	@Override
	public boolean update(TemplateDTO course) {
