...
public class HIBERNATEgenerator {
	...
	public static void main(String[] args) throws IOException {
		...
		// CAMBIARE DA QUI...
		objName = "OggettoDigitale"; // nome del bean (iniziale maiuscola!!)
		tableName = "oggettodigitale"; // nome della tabella

		// non inserire "int id"!! (generato automaticamente)
		attr.add("String codiceOggetto"); // coppie "tipo nome" separate da uno spazio
		attr.add("String nome"); // NON inserire qui eventuali set (sono da scrivere a mano dopo la generazione!!)
		attr.add("String formato");
		attr.add("Date dataDigitalizzazione");
		/// ...A QUI
		...
		out.write("\t\t\t<generator class=\"native\"></generator>\n");
		out.write("\t\t</id>\n");
