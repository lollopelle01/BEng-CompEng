...
public class ServerWS {
	...
	private OperationResp lastOperation = new OperationResp();  //risultato precedente
	...
	public void handleMessage(String message, Session session)throws IOException, EncodeException {
		...
		if(message.equals("gioca")) {
			...
			if(count==10) {
				...
				broadcast(count +" numero giocatori");
		}
		//caso messaggio: richiesta operazione
		else {
