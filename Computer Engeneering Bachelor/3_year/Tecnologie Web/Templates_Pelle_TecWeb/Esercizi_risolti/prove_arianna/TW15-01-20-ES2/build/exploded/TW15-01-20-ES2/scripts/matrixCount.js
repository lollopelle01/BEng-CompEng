...
function printResult( stringa ) {
	...
	// variabili di funzione
		...
		//secondo me manca la parte in cui modifico i campi da hidden a text
}// parsificaJSON()
...
function myFunction(caller)
{
	...
	var mode = caller.getAtribute("id"); //oppure name
	
	var aValues = "";
	var bValues = "";
	for(var i=0; i<8;i++) //creo due stringhe con i valori delle matrici A e B
		{
