...
public class HIBERNATEgenerator {
	...
	public static void main(String[] args) throws IOException {
		...
		// CAMBIARE DA QUI...
		objName = "TipoAccertamento"; // nome del bean (iniziale maiuscola!!)
		tableName = "tipoaccertamento"; // nome della tabella

		// non inserire "int id"!! (generato automaticamente)
		attr.add("String codice"); // coppie "tipo nome" separate da uno spazio
		attr.add("String descrizione"); // NON inserire qui eventuali set (sono da scrivere a mano dopo la generazione!!)
//		attr.add("String indirizzo");
//		attr.add("Date data");
		/// ...A QUI
