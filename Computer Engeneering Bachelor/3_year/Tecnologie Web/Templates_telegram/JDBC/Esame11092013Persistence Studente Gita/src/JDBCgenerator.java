...
public class JDBCgenerator {
	...
	public static void main(String[] args) throws IOException {
		...
		// CAMBIARE DA QUI...
		objName = "Partecipazione"; // nome del bean (iniziale maiuscola!!)
		tableName = "partecipazione"; // nome della tabella

		ID_NAME = "CodGita"; // mettere maiuscola

		attr.add("String luogo");
		attr.add("Date data");
		attr.add("double costo");
		/// ...A QUI
