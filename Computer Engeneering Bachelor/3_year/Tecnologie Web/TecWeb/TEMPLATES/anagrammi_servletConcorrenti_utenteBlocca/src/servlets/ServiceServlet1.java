...
public class ServiceServlet1 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//per 10 anagrammi diversi
		for(int i = 0; i < 10; i++) {
			String anagramma = "";
			int attempts = 0; //numero di tentativi per formare l'anagramma, se supera 50 termino la ricerca
			...
			} while(anagrammi.contains(anagramma) && attempts < 50);
