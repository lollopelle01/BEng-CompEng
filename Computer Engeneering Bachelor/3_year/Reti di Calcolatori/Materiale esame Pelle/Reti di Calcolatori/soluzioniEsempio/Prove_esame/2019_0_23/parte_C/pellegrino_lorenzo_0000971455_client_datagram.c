...
int main(int argc, char **argv) {
    ...
    printf("Scrivi la tua targa, EOF per terminare: ");

    while (scanf("%s", req.targa) == 1) {
        printf("Scrivi la tua nuova patente: ");
        scanf("%s", req.newPatente);
        ...
        if (ris == -1) {
            ...
            printf("Sostituzione avvenuta correttamente\n");
        }
        printf("Scrivi la tua targa, EOF per terminare: ");
    } // while
} // main