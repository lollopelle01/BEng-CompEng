...
try:
    ...
    print "[!] Esecuzione avvenuta con successo \n Se si vuole runnarlo in locale installare 'python-lxml' (e.g. '%s')\n " % ("apt install python-lxml" if not subprocess.mswindows else "https://pypi.python.org/pypi/lxml")

NAME, VERSION, GITHUB, AUTHOR, LICENSE = "Sec Lab Prova 2 Web (2022) < Path Traversal Challenge", "0.01", "https://gitlab.com/wild_boar/labsec_course", "@wild_boar", "GPLv3"
        ...
        try:
            if path == '/':
                ...
                if HTML_PREFIX in content and HTML_POSTFIX not in content:
                    content +="<div><span>Web Challenge 2:</span></div>\n"
