...
NAME, VERSION, GITHUB, AUTHOR, LICENSE = "Sec Lab Prova 3 Web (2022) < Command Execution Challenge", "0.01", "https://gitlab.com/wild_boar/labsec_course", "@wild_boar", "GPLv3"
        ...
        try:
            if path == '/':
                ...
                if HTML_PREFIX in content and HTML_POSTFIX not in content:
                    content +="<div><span>Web Challenge 3:</span></div>\n"
