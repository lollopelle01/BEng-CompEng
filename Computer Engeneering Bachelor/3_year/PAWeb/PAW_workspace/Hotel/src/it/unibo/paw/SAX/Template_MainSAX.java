...
public class Template_MainSAX {
	...
	public static void main(String args[]) {
		...
		try
		{
			...
			xmlReader.parse("src/it/unibo/paw/sources/hotel.xml");
			
			// 4) Visualizzare risultato
			FileWriter fw = new FileWriter("Hotel.txt");
			fw.write("Gli hotel (tra i risultati) su cui l'utente ha cliccato sono:\n");
			for(String s : contentHandler.getSelezione()) {
				fw.write(s + "\n");
			}
			fw.close();
		}
