...
public class Db2DAOFactory extends DAOFactory {
	...
	public static final String USERNAME = "A0971455";
	public static final String PASSWORD = "katiusha1_2";
	...
	// getter DAO
	@Override
	public VoloAeroportoBoDAO getVoloAeroportoBoDAO() {
		return new Db2VoloAeroportoBoDAO();
	}
	
	@Override
	public PasseggeroDAO getPasseggeroDAO() {
		return new Db2PasseggeroDAO();
	}
	
	@Override
	public TemplateMappingDAO getTemplateMappingDAO() {
		return new Db2TemplateMappingDAO();
	}
