...
public class CupidoTests
{
	...
	{	
		...
		assertEquals(85, c.indiceCompatibilità(iscritti.get("Ludovica"), preferenze.get("Roberto"))); //ho modificato corr2 da 93 a 85
	...
	{	
		...
		assertTrue(corr2.compareTo(corr1)==+1); // corr2<corr1 perché 85<90  ho modificato corr2 da 93 a 85
