const socket = new WebSocket("ws://localhost:8080/07_TecWeb_solved/actions2");
	 ...
	 if(event.data.includes("update"))
		 {
		 	...
		 	var toUpdateElement = document.getElementById(toUpdate);
		 	toUpdateElement.value = message.valore;
		 	return;
		 }
	 if(message.valid)
		 {
