...
function myFunction(caller)
{
	...
	var aValues = "";
	var bValues = "";
	for(var i=0; i<8; i++)   //ricostruisco le due matrici
		{
			aValues = aValues + myGetElementById("a"+i).value+"@";   //valori della matrice A, uso @ come token per dividere i valori che inserisco
			bValues = bValues + myGetElementById("b"+i).value+"@";   //valori della matrice B, uso @ come token per dividere i valori che inserisco
		}
	var	xhr = myGetXmlHttpRequest();
