...
<html>
	...
	<body>
		<h3>Benvenuto, inserisci le tue credenziali da admin o fai il Login</h3>
		<form name="Login" action="servletLogin" method="POST">
			<table>
				<tr>
					<td><input type="text" name="username" size="30" placeholder="Username"></td>
				</tr>
				<tr>
					<td><input type="text" name="password" size="30" placeholder="Password"></td>
				</tr>
				<tr>
					<td><input type="submit" name="Login" value="LogIn" size="30"></td>
				</tr>
			</table>
		</form>
		<div>
			...
			%>
					<p>
						<b> Errore: troppi utenti collegati</b>
					</p>
			<%
						}
						break;
