...
public class HIBERNATEgenerator {
	...
	public static void main(String[] args) throws IOException {
		...
		// CAMBIARE DA QUI...
		objName = "Tre"; // nome del bean (iniziale maiuscola!!)
		tableName = "tre"; // nome della tabella

		// non inserire "int id"!! (generato automaticamente)
		attr.add("String tre1"); // coppie "tipo nome" separate da uno spazio
		attr.add("String tre2"); // NON inserire qui eventuali set (sono da scrivere a mano dopo la generazione!!)
//		attr.add("Date data");
		/// ...A QUI
