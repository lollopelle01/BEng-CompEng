...
public class DAOgenerator
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		objName="Piatto"; //nome del bean (iniziale maiuscola!!)
		tableName="piatto"; //nome della tabella

		//non inserire "long id"!! (generato automaticamente)
		attr.add("String nomePiatto"); //coppie "tipo nome" separate da uno spazio
		attr.add("String tipo");
