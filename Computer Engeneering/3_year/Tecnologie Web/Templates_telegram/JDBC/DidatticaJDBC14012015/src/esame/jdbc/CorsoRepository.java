...
"CREATE TABLE corso (CodiceCorso VARCHAR(50) NOT NULL PRIMARY KEY,nome VARCHAR(50) NOT NULL,creditiFormativi INT NOT NULL, CHECK (creditiFormativi > 0))"; 
	...
	{ 
		...
		{ 
			...
			statement.setString(1,obj.getCodiceCorso());
	...
	{ 
		...
		{ 
			...
			statement.setString(3,obj.getCodiceCorso());
	...
	public Corso read(String id) throws PersistenceException 
	{ 
Corso res = null; 
		Connection connection = null; 
		PreparedStatement statement = null; 
		try { 
			...
			{ 
				res = new Corso (); 
				res.setCodiceCorso(results.getString("CodiceCorso"));
